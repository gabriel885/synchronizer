...
public class CliParser {
    ...
    // devices option
    Option devicesCliOption = new Option("d","devices", true,"devices with port to connect the p2p network. example: 10.0.0.1:4321, 10.0.0.2:2019 10.0.0.0.5:1234");
    ...
    public CliParser(){
        ...
        // print usage
        this.formatter.printHelp(usage,cliOptions);
