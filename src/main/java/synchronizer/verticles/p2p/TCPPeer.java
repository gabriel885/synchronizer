 ...
 */
// implements Protocol
    // tcpPeer must be deployed first before calling any methods!
public class TCPPeer extends NetPeer implements Protocol {
     ...
     * @throws Exception
     */
    private TCPPeer(String hostname, int port, Set<Peer> peers) throws Exception {
     ...
     * @throws Exception
     */
    private TCPPeer(String hostname, int port, Set<Peer> peers, NetServerOptions serverOptions) throws Exception {
     ...
     * @throws Exception
     */
    private TCPPeer(String hostname, int port, Set<Peer> peers, NetClientOptions clientOptions, NetServerOptions serverOptions) throws Exception {
